...
export type ToolId = 'group' | 'references' | 'guide' | 'image' | 'settings' | 'sound' | 'progress' | 'study' | 'breakdown';
export const toolNames: Record<ToolId,string> = { group:'Group Study', references:'References', guide:'Passage guide', image:'Verse image', settings:'Settings', sound:'Sound', progress:'Your reading', study:'Plans & circles', breakdown:'Break it down' };
