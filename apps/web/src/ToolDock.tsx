...
export type ToolId = 'group' | 'references' | 'guide' | 'image' | 'settings' | 'sound';
export const toolNames: Record<ToolId,string> = { group:'Group Study', references:'References', guide:'Passage guide', image:'Verse image', settings:'Settings', sound:'Sound' };
